...
local propRPMR = sensor_data.getEngineRightRPM()*(propMaxRPM/100)
	...
	set_aircraft_draw_argument_value(DRAW_FAN3,propState)
	set_aircraft_draw_argument_value(DRAW_FAN4,propState)
end